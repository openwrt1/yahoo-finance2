...
export function detectRuntime(): RuntimeInfo {
  ...
  const deno = (dntShim.dntGlobalThis as any).Deno;
  const proc = (dntShim.dntGlobalThis as any).process;
  ...
  if (/Cloudflare-Workers/i.test(ua)) {
    ...
    info.details = {
      userAgent: ua,
      miniflare: !!(dntShim.dntGlobalThis as any).MINIFLARE || /Miniflare/i.test(ua),
      hasWebSocketPair:
        typeof (dntShim.dntGlobalThis as any).WebSocketPair !== "undefined",
      hasCaches: typeof (dntShim.dntGlobalThis as any).caches !== "undefined",
    };
    return info;
  }
  if (
    typeof (dntShim.dntGlobalThis as any).process === "undefined" &&
    typeof (dntShim.dntGlobalThis as any).Deno === "undefined" &&
    typeof (dntShim.dntGlobalThis as any).Bun === "undefined" &&
    typeof (dntShim.dntGlobalThis as any).WebSocketPair !== "undefined" &&
    typeof (dntShim.dntGlobalThis as any).caches !== "undefined"
  ) {
    info.runtime = "cloudflare";
    info.version = null;
...
export function checkSupport(policy: SupportPolicy = {}): SupportCheckResult {
  ...
  const hasGlobalPath = (path: string): boolean => {
    ...
    let cur: any = dntShim.dntGlobalThis;
